...
from typing import Final # Added by me
...
TOKEN: Final = '6114910026:AAGGPogroG1BvkHA3LOTab_0EzBqqi3JQYM' # Added by me
BOT_USERNAME: Final = '@GetMyTermin_bot' # Added by me
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    logger.info("First name is: %s", user.first_name)
    logger.info("Last name is %s", user.last_name)
...
3. You are responsible for entering accurate information and verifying it before submitting. Any issues that arise due to incorrect information entered are your sole responsibility.'''
    ...
    keyboard = [
        [
            InlineKeyboardButton('I agree ✅', callback_data=str(ONE)),
...
async def start_over(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # interactive menu.
    await query.edit_message_text(text='Please check the box below to indicate that you have read and agree to all the Terms and Conditions mentioned above:', reply_markup=reply_markup)
    return START_ROUTES
